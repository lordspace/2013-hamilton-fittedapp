                    ...
                    <section id="download-bootstrap">
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                ...
                                <p><a class="btn btn-large btn-primary" href="assets/bootstrap/bootstrap.zip" onclick="_gaq.push(['_trackEvent', 'Getting started', 'Download', 'Download compiled']);">Download Bootstrap</a></p>
                            </div>
                            <div class="span6">
                        ...
                        <ul class="thumbnails bootstrap-examples">
                            <li class="span3">
                                <a class="thumbnail" href="examples/starter-template.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-starter.png" alt="">
                                </a>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/hero.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-marketing.png" alt="">
                                </a>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/fluid.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-fluid.png" alt="">
                                </a>
                                <h4>Fluid layout</h4>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/marketing-narrow.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-marketing-narrow.png" alt="">
                                </a>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/justified-nav.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-justified-nav.png" alt="">
                                </a>
                                <h4>Justified nav</h4>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/signin.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-signin.png" alt="">
                                </a>
                                <h4>Sign in</h4>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/sticky-footer.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-sticky-footer.png" alt="">
                                </a>
                                <h4>Sticky footer</h4>
                            ...
                            <li class="span3">
                                <a class="thumbnail" href="examples/carousel.html">
                                    <img src="assets/bootstrap/img/examples/bootstrap-example-carousel.png" alt="">
                                </a>
